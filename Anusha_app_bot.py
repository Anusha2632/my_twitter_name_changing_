...
while True:
  user=api.get_user('Anusha35800208')
  api.update_profile(name=f'Anusha|{follower_count(user)} Followers')
  print(f'Updating Twitter Name: Anusha|{follower_count(user)} Followers')
